...
export class App extends Component {
    ...
    getUser (token) {
        ...
        axios.get('api/auth/user', {headers: headers})
            .then(res => {
    ...
    handleLogout () {
        axios.post('api/auth/logout', null, {headers: {Authorization: `Token ${this.state.token}`}})
            .then(res => {
    ...
    render() {
        ...
        return (
            <Fragment>
                <Router>
                    <Header user={username} isAuth={isAuth} handleLogout={this.handleLogout.bind(this)}/>
                    <div className="container">
                        <Switch>
                            <Route exact path="/" component={Posts}/>
                            <Route path="/coins" component={(props) => <Coins {...props} isAuth={isAuth} token={token} />} />
