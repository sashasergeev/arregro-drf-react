...
export const Cards = (props) => {
    ...
    return (
        ...
        justifyContent="center">
            {cards && cards.map((e, inx) => {
                return (
                    <Grid item key={inx} className={huo} style={{position: 'relative'}}>
                        <Card className={root} style={{position: 'relative'}}> 
                            ...
                            <CardContent>
                                <Typography variant="body1"  component="p" style={{fontFamily: "Quicksand, sans-serif"}}>
                                    {e.message}
                                </Typography>
                            </CardContent>
                            <Grid container spacing={3} style={{padding: 10}}>
                                    ...
                                    <Grid item xs={4} >
                                        <Paper className={paper}
                                            style={e.change > 0 ? {color: '#27d030'} : {color: '#f50057'}}
                                            elevation={0}
                                            square 
                                        >
                                            {e.change}%
                            ...
                            <CardActions className={bdy}>
                                ...
                                <InfoOutlinedIcon style={{width: 42, height: 42}}>info</InfoOutlinedIcon>
                            </CardActions>
